...
class Install : CommandProcessor() {
    ...
    fun applySystemConfigProperties(){
        ...
        try {
            ...
            system_config.put(DOC_LIBRARY_BASE_PATH, "$imsHome$separator$DOC_LIBRARY_DIRECTOR_NAME")
            system_config.put(ATTACHMENT_ROOT_PATH, "$imsHome$separator$ATTACHMENT_DIRECTOR_NAME")
            system_config.put(PROCESS_EXPORT_EXCEL_PATH, "$imsHome$separator$PROCESS_EXPORT_DIRECTOR_NAME")
            system_config.put(INDEX_PATH, "$imsHome$separator$INDEX_DIRECTOR_NAME")
            system_config.put(IMS_HOME, "$imsHome$separator$IMS_HOME_PATH")
            system_config.put(REPORT_EXEURL, "$imsHome$separator$REPORT_PATH")
